...
public class ProgramadoAnuncioStrategy implements AnuncioTipoStrategy {
    public Anuncio inicializar(CrearAnuncioRequestDTO dto, Usuario creador, Inmueble inmueble) {
        return base(dto, creador, inmueble, EstadoAnuncio.PROGRAMADO, dto.requiereConfirmacion, dto.fechaProgramada);
    }
}
